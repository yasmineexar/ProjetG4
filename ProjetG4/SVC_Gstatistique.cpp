...
namespace Service {
    ...
    String^ SVC_Gstatistique::calcul_chiffreaffaire() //mensuel
    {
        return "SELECT sum("+this->artcmd->getprixht()*this->artcmd->getQuantiteArticle()+") as Chiffre Affaire FROM Choisir";
    }
